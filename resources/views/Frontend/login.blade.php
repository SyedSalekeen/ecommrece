...
body {
	...
	place-items: center;
	color: #000;
	background: #D10024;  /* fallback for old browsers */
background: -webkit-linear-gradient(to right, #D10024, #AA076B);  /* Chrome 10-25, Safari 5.1-6 */
background: linear-gradient(to right, #D10024, #AA076B); /* W3C, IE 10+/ Edge, Firefox 16+, Chrome 26+, Opera 12+, Safari 7+ */
    ...
    <body>
		<div class="login-form">
			...
			<form action="#" class="form">
				...
				<input type="password" required placeholder="Password" pattern=".{8,}">
